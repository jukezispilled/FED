...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-green-500 p-4 md:p-6 pt-[7.5%] md:pt-[3.5%] font-mono">
      <div className='absolute top-0 left-0 w-full bg-green-500 py-1 text-xs text-center text-black'>CA: 2uxH2KBQ8WNfLHoA1b1P9fYqLyMAwyrPw8QpDKy5pump</div>
      <header className="flex items-center justify-between mb-4">
        <h1 className="text-xl md:text-3xl font-bold">SPY Terminal v1.0</h1>
        <div className='flex space-x-3'>
            <div className='flex items-center z-[50]'>
            <a href="https://x.com/SPYMONKEYSOL" className='transition ease-in-out duration-150'>
            ...
            <a href="https://t.me/SPYPORTALSOL" className='transition ease-in-out duration-150'>
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className='size-7 md:size-9 md:hover:scale-105 transition ease-in-out duration-150 cursor-pointer' fill="#22c55e" viewBox="0 0 50 50">
